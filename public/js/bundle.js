...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmlrZXQwOTA5IiwiYSI6ImNreDk3M25rZjB3ZXUybm1ubnl0aHU3Z2IifQ.8JaNSKkMC4QIo7mfyvtRTA';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged Out succesfully !!'); // location.reload();
...
var userPasswordForm = document.querySelector('.form-user-settings'); // console.log(loginForm);
